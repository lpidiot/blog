...
public class tagUtil {
    ...
    private List<String> current_tags = null;  //当前操作标签列表
    ...
    private void init() {
        ...
        current_tags = new ArrayList<>(Arrays.asList(flag));
    ...
    private void nextTag() {
        System.out.println(current_tags.toString());
        //开始下一篇文章
        index++;
        //准备tag数据
        try {
    ...
    private String getCurrentTag() {
        try {
            return current_tags.get(tag_index);
        } catch (Exception e) {
